...
namespace MercDevs_ej2.Controllers
{
    public class DatosfichatecnicasController : Controller
    {
        ...
        public async Task<IActionResult> Index(int id)
        {
            var fichaTecnica = await _context.Datosfichatecnicas
                .Include(d => d.RecepcionEquipo)
                .Include(d => d.Diagnosticosolucions) //DescripcionSolucion
                    .ThenInclude(d => d.DescripcionSolucion)
                .Include(d => d.Diagnosticosolucions) //DescripcionDiagnostico
                    .ThenInclude(d => d.DescripcionDiagnostico)
